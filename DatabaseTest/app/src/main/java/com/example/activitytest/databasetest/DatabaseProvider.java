...
/**
 * Created by lingnanmiao on 8/29/17.
 */
...
public class DatabaseProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.example.activitytest.databasetest.provider";
    ...
    public Uri insert( Uri uri, ContentValues contentValues) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case CATEGORY_DIR:
            case CATEGORY_ITEM:
                long newCateId = db.insert("Category", null, contentValues);
                uriReturn = Uri.parse("content://"+AUTHORITY+"/book/"+newCateId);
                break;
            default:
                break;
        }
    ...
    public int update(@NonNull Uri uri, @Nullable ContentValues contentValues, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case BOOK_ITEM:
                String bookId = uri.getPathSegments().get(1);
                db.update("Book", contentValues, "id = ?", new String[]{bookId});
                break;
            case CATEGORY_DIR:
    ...
    public int delete(@NonNull Uri uri, @Nullable String s, @Nullable String[] strings) {
        ...
        switch (uriMatcher.match(uri)){
            ...
            case CATEGORY_DIR:
                ...
                break;
            case CATEGORY_ITEM:String cateId = uri.getPathSegments().get(1);
                deletedRows = db.delete("Category", "id = ?", new String[]{cateId});
                break;
            default:
                break;
